...
for country in countries_list:
    ...
    c_pars = {(country, 'Logistic', 'a'): ai, (country, 'Logistic', 'b'): bi, (country, 'Logistic', 'c'): ci,
              (country, 'Logistic', 'sga'): sigma_ai, (country, 'Logistic', 'sgb'): sigma_bi,
              (country, 'Logistic', 'sgc'): sigma_ci}
...
for country in countries_list:
    ...
    print("Prediction from " + chosenmodel + " Model : ", frm(prediction),
          ' ( +' + frm(pluspred - prediction) + ', -' + frm(prediction - minuspred) + ')')
